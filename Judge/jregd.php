...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (move_uploaded_file($_FILES["img"]["tmp_name"], $target_file)) {
    ...
    try {
      ...
      $query = "INSERT INTO `judge_info` (`j_slno`, `j_regd`, `j_name`, `j_email`, `j_phn`, `j_pass`, `j_path`, `status`) VALUES (NULL, '$regd', '$name', '$email', '$contactno', '$password', '$target_file', '1')";
      ...
      if ($result) {
        ...
        echo '
                        ...
                        <p>Aww yeah, you successfully registered your Employee ID in Judicial Case Management System !<br>
                            Thankyou and enjoy your online dashboard in every where.</p>
                        <hr>
                        <p class="mb-0">Now login your dashboard panel -> <a href="j_login.php">Login Now</a>.</p>
                        </div>
                        </div>';
      } else {
      ...
      echo '
          ...
          <hr>
          <p class="mb-0">Try again -> <a href="j_signup.php">SignUP Again</a>.</p>
          </div>
          </div>';
    }
  } else {
