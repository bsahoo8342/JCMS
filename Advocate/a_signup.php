...
<head>
    ...
    <title>Advocate Register | JCMS</title>
</head>
...
<body>
    ...
    <div class="container boxtbl">
        <h3 class="text-center">Advocate Registration Form</h3>
        <form action="regd.php" method="post" enctype="multipart/form-data">

            <div class="container col-md-8 mt-4">
                <div class="row g-3 mb-2">
                    <div class="col mb-2 ">
                        <label for="Regd" class="form-label">Registration Number</label>
                        <input type="text" class="form-control" placeholder="OR-11-YYYY" aria-label="First name"
                            id="Regd" name="RegistrationNo" required>
                    </div>
                </div>
                <div class="row g-3 mb-2">
                    <div class="col-md-6 px-2">
                        <label for="fname" class="form-label">First Name</label>
                        <input type="text" class="form-control" placeholder="First name with Middle name"
                ...
                <div class="row g-3 mb-2">
                    <div class="col-md-6 px-2">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="someone@mail.com"
                            aria-label="someone@mail.com" name="Email" required>
                    </div>
                    <div class="col-md-6 ps-2">
                        <label for="Number" class="form-label">Phone Number</label>
                        <input type="number" class="form-control" id="Number1" placeholder="0987654321" maxlength="10"
                            minlength="10" aria-label="0987654321" name="ContactNumber" required>
                    </div>
                </div>
                <div class="row g-3 mb-2">
                    <div class="col-md-6 px-2">
                    ...
                    <div class="col-md-6 ps-2">
                        ...
                        <input type="password" class="form-control" id="pass2" placeholder="Confirm Password"
                            aria-label="Confirm Password" name="cpass" required onkeyup="validate_password()">
                ...
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-md-6 ps-2">
                        ...
                        <div class="card" style="width: 10rem;">
                            <img src="../img/user.png" height="140px" class="card-img-top" alt="image" accept="image/*"
                                id="profile" name="photo">
